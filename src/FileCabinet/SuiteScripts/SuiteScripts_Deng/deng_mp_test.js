...
(record, search, runtime, currency) => {

    const getInputData = () => {
        let search_id = runtime.getCurrentScript().getParameter('custscript6');
        let my_search = search.load({id: search_id});
        return my_search.run().getRange(0, 1000);
    }
